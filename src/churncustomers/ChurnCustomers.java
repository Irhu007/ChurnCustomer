...
public class ChurnCustomers {
	...
	Job job_obj = new Job(conf, "Churn Customer");
	// setting name of main class
	job_obj.setJarByClass(ChurnCustomers.class);
	//name of mapper class
	job_obj.setMapperClass(ChurnMapper.class);
		// name of reducer class
	job_obj.setReducerClass(ChurnReducer.class);
